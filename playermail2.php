...
<hr><h4 style="color:Red;">使用后台刷物品，务必注意数量，玩家操作满背包不补号，切记！</h4><hr/>
 <h3 style="color:blue"><?php echo $_SESSION['name'];?> 欢迎登陆</h3> 
	 <button class="btn btn-info btn-block" onclick="window.location.href='player3.php'">元宝充值</button>
	 <button class="btn btn-info btn-block" onclick="window.location.href='playermail3.php'">刷物品【邮件】</button>
...
<div class="form-group">
 <p class="admin_copyright"> &copy; 2023 Powered by 修仙西游</p> </div>
</body>
</html>