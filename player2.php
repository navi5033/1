...
<hr><h4 style="color:Red;">使用后台刷物品，务必注意数量，玩家操作满背包不补号，切记！</h4><hr/>
 ...
 <label style="color:red" for="v">您的账号到期时间：<?php echo $_SESSION['endtime'];?></label> <br>
	 <button class="btn btn-info btn-block" onclick="window.location.href='player2.php'">元宝充值</button>
	 <button class="btn btn-info btn-block" onclick="window.location.href='playermail2.php'">刷物品【邮件】</button>
