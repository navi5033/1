...
<form id="form1" name="form1" method="post" action="playerquery.php">
    ...
    <div class="form-group">
        ...
        fclose($file);
			...
			<input type="text" placeholder="数量" class="form-control" id="num" name="num" value="1" maxlength="4">
		<div class="form-group">
...
<div class="form-group">
 <p class="admin_copyright"> &copy; 2019 Powered 西游大乱斗</p> </div>
</body>
</html>